    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.addinTest.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.addinTest.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'addinTest'){
                    geotab.addin.addinTest.blur();
                } else {
                    geotab.addin.addinTest.focus(global.api, global.state);
                }
            }
        }, 100);
    }
